...
///     Used by <see cref="Controllers.BaseApiController"/> so controllers don't have to look up claim
///     types directly, regardless of whether the user was authenticated via the Identity cookie or a
///     JWT bearer token.
/// </summary>
