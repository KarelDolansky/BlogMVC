...
/// <summary>User administration API at "api/users". Currently limited to role assignment.</summary>
/// <param name="userService">Service handling Identity role assignments.</param>
[ApiController]
